...
var_dump(array_key_exists($key1, $someKeys)); // true
var_dump(array_key_exists($key2, $someKeys)); // true
var_dump(array_key_exists($key3, $someKeys)); // true
var_dump(array_key_exists($key4, $someKeys)); // true
var_dump(array_key_exists($key5, $someKeys)); // false
var_dump(array_key_exists($key6, $someKeys)); // true
var_dump(array_key_exists($key7, $someKeys)); // false

HTML::br();
HTML::br();
var_dump(array_key_exists(null, $someKeys)); // false
var_dump(array_key_exists($dataFactory, $someKeys)); // false + warning
