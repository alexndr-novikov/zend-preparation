...
class SubCategory
{
    ...
    {
        return "<h4 class='collapse-control' data-toggle='collapse' data-target='#{$this->id}' id='control-{$this->id}' aria-expanded='false' aria-controls='collapseExample'>$this->name</h4>"  . $this->renderChildren($parentDir . '/' . $this->directory);
    }
