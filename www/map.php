...
//            new \Doc\models\DocPage('usort()', 'usort'),
        ...
        new \Doc\models\SubCategory('Strings', 'strings', [
            ...
            new \Doc\models\DocPage('crypt', 'crypt'),
            new \Doc\models\DocPage('echo', 'echo'),
            new \Doc\models\DocPage('explode', 'explode'),
            new \Doc\models\DocPage('fprintf', 'fprintf'),
            new \Doc\models\DocPage('get_html_translation_table', 'get_html_translation_table'),
            new \Doc\models\DocPage('hebrev', 'hebrev'),
            new \Doc\models\DocPage('hebrevc', 'hebrevc'),
            ...
            new \Doc\models\DocPage('localeconv', 'localeconv'),
            ...
            new \Doc\models\DocPage('quotemeta', 'quotemeta'),
            new \Doc\models\DocPage('rtrim', 'rtrim'),
            new \Doc\models\DocPage('setlocale', 'setlocale'),
            new \Doc\models\DocPage('sha1_file', 'sha1_file'),
            new \Doc\models\DocPage('sha1', 'sha1'),
            new \Doc\models\DocPage('similar_text', 'similar_text'),
            new \Doc\models\DocPage('soundex', 'soundex'),
            new \Doc\models\DocPage('sprintf', 'sprintf'),
            new \Doc\models\DocPage('sscanf', 'sscanf'),
            new \Doc\models\DocPage('str_getcsv', 'str_getcsv'),
            new \Doc\models\DocPage('str_ireplace', 'str_ireplace'),
            new \Doc\models\DocPage('str_pad', 'str_pad'),
            new \Doc\models\DocPage('str_repeat', 'str_repeat'),
            new \Doc\models\DocPage('str_replace', 'str_replace'),
            ...
            new \Doc\models\DocPage('stripslashes', 'stripslashes'),
            new \Doc\models\DocPage('stristr', 'stristr'),
            ...
            new \Doc\models\DocPage('strrpos', 'strrpos'),
            new \Doc\models\DocPage('strspn', 'strspn'),
            ...
            new \Doc\models\DocPage('substr_replace', 'substr_replace'),
            new \Doc\models\DocPage('substr', 'substr'),
        ...
        new \Doc\models\SubCategory('Filesystem', 'filesystem', [
            ...
            new \Doc\models\DocPage('chown()', 'chown'),
